...
import { getResistanceFeatures } from '../utils/api';
  ...
  useEffect(() => {
    ...
    const loadFeatureImages = async () => {
      try {
        ...
        const features = await getResistanceFeatures(analysisId);
        setFeatureImages({
    ...
    <div className="feature-page">
      ...
      <div className="feature-content">
        ...
        <div className="action-buttons">
          <button className="back-button" onClick={handleBackToResistance}>
            回到上頁
          </button>
